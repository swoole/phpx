...
TEST(helper_equals, float_equals) {
    ...
    ASSERT_TRUE(php::equals(2.0, static_cast<Int>(2L)));
    ASSERT_TRUE(php::equals(static_cast<Int>(3L), 3.0));

    ASSERT_FALSE(php::equals(2.1, static_cast<Int>(22L)));
    ASSERT_FALSE(php::equals(static_cast<Int>(3L), 3.23));
}
...
TEST(helper_misc, toFloat) {
    ASSERT_EQ(php::toFloat(static_cast<Float>(34L)), 34.00);
