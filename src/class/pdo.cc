...
Variant PDOStatement::bindColumn(const Variant &column,
    ...
    return this_.exec(LITERAL_STRING[834], {column, &var, type, max_length, driver_options});
}
Variant PDOStatement::bindParam(const Variant &param,
                                ...
                                const Variant &max_length,
                                const Variant &driver_options) {
    return this_.exec(LITERAL_STRING[835], {param, &var, type, max_length, driver_options});
}
...
Variant PDOStatement::closeCursor() {
    return this_.exec(LITERAL_STRING[837], {});
}
Variant PDOStatement::columnCount() {
    return this_.exec(LITERAL_STRING[838], {});
}
Variant PDOStatement::debugDumpParams() {
    return this_.exec(LITERAL_STRING[839], {});
}
...
Variant PDOStatement::getColumnMeta(const Variant &column) {
    return this_.exec(LITERAL_STRING[845], {column});
}
Variant PDOStatement::nextRowset() {
    return this_.exec(LITERAL_STRING[846], {});
}
Variant PDOStatement::rowCount() {
    return this_.exec(LITERAL_STRING[847], {});
}
