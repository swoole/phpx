...
Variant PDO::connect(const Variant &dsn, const Variant &username, const Variant &password, const Variant &options) {
    static Variant fn { ZEND_STRL("PDO::connect"), true };
    return fn({dsn, username, password, options});
}
...
Variant PDOStatement::bindColumn(const Variant &column, const Reference &var, const Variant &type, const Variant &max_length, const Variant &driver_options) {
    return this_.exec("bindColumn", {column, &var, type, max_length, driver_options});
}

Variant PDOStatement::bindParam(const Variant &param, const Reference &var, const Variant &type, const Variant &max_length, const Variant &driver_options) {
