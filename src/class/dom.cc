...
Variant AdjacentPosition::cases() {
    ...
    if (UNEXPECTED(!_method_fn)) {
        _method_fn = php::getMethod(LITERAL_STRING[331], LITERAL_STRING[333]);
    }
...
Variant AdjacentPosition::from(const Variant &value) {
    static THREAD_LOCAL zend_function *_method_fn = nullptr;
    if (UNEXPECTED(!_method_fn)) {
        _method_fn = php::getMethod(LITERAL_STRING[331], LITERAL_STRING[335]);
    }
...
Variant AdjacentPosition::tryFrom(const Variant &value) {
    static THREAD_LOCAL zend_function *_method_fn = nullptr;
    if (UNEXPECTED(!_method_fn)) {
        _method_fn = php::getMethod(LITERAL_STRING[331], LITERAL_STRING[337]);
    }
    return php::call(_method_fn, {value});
}
...
NodeList::NodeList() {
    this_ = newObject(LITERAL_STRING[432]);
}
...
CharacterData::CharacterData() {
    this_ = newObject(LITERAL_STRING[450]);
}
...
Variant CharacterData::appendData(const Variant &data) {
    static THREAD_LOCAL zend_function *_method_fn = nullptr;
    if (UNEXPECTED(!_method_fn)) {
        _method_fn = php::getMethod(this_.ce(), LITERAL_STRING[441]);
    }
...
Variant CharacterData::insertData(const Variant &offset, const Variant &data) {
    static THREAD_LOCAL zend_function *_method_fn = nullptr;
    if (UNEXPECTED(!_method_fn)) {
        _method_fn = php::getMethod(this_.ce(), LITERAL_STRING[443]);
    }
...
Text::Text() {
    this_ = newObject(LITERAL_STRING[486]);
}
...
Comment::Comment() {
    this_ = newObject(LITERAL_STRING[488]);
}
CDATASection::CDATASection() {
    this_ = newObject(LITERAL_STRING[490]);
}
DocumentType::DocumentType() {
    this_ = newObject(LITERAL_STRING[492]);
}
...
DtdNamedNodeMap::DtdNamedNodeMap() {
    this_ = newObject(LITERAL_STRING[437]);
}
...
ProcessingInstruction::ProcessingInstruction() {
    this_ = newObject(LITERAL_STRING[500]);
}
XPath::XPath(const Variant &document, const Variant &register_node_n_s) {
    this_ = newObject(LITERAL_STRING[509], {document, register_node_n_s});
}
...
Variant XPath::registerNamespace(const Variant &prefix, const Variant &namespace_) {
    static THREAD_LOCAL zend_function *_method_fn = nullptr;
    if (UNEXPECTED(!_method_fn)) {
        _method_fn = php::getMethod(this_.ce(), LITERAL_STRING[504]);
    }
...
Variant XPath::quote(const Variant &str) {
    static THREAD_LOCAL zend_function *_method_fn = nullptr;
    if (UNEXPECTED(!_method_fn)) {
        _method_fn = php::getMethod(LITERAL_STRING[509], LITERAL_STRING[508]);
    }
...
DocumentFragment::DocumentFragment() {
    this_ = newObject(LITERAL_STRING[375]);
}
...
HTMLCollection::HTMLCollection() {
    this_ = newObject(LITERAL_STRING[438]);
}
...
Element HTMLCollection::namedItem(const Variant &key) {
    static THREAD_LOCAL zend_function *_method_fn = nullptr;
    if (UNEXPECTED(!_method_fn)) {
        _method_fn = php::getMethod(this_.ce(), LITERAL_STRING[439]);
    }
...
Element::Element() {
    this_ = newObject(LITERAL_STRING[476]);
}
...
Variant Element::getAttributeNS(const Variant &namespace_, const Variant &local_name) {
    static THREAD_LOCAL zend_function *_method_fn = nullptr;
    if (UNEXPECTED(!_method_fn)) {
        _method_fn = php::getMethod(this_.ce(), LITERAL_STRING[458]);
    }
    return this_.call(_method_fn, {namespace_, local_name});
}
...
Variant Element::getInScopeNamespaces() {
    static THREAD_LOCAL zend_function *_method_fn = nullptr;
    if (UNEXPECTED(!_method_fn)) {
        _method_fn = php::getMethod(this_.ce(), LITERAL_STRING[479]);
    }
    return this_.call(_method_fn, {});
}
...
HTMLDocument::HTMLDocument() {
    this_ = newObject(LITERAL_STRING[411]);
}
HTMLDocument HTMLDocument::createEmpty(const Variant &encoding) {
    static THREAD_LOCAL zend_function *_method_fn = nullptr;
    if (UNEXPECTED(!_method_fn)) {
        _method_fn = php::getMethod(LITERAL_STRING[411], LITERAL_STRING[413]);
    }
...
HTMLDocument HTMLDocument::createFromFile(const Variant &path,
    ...
    static THREAD_LOCAL zend_function *_method_fn = nullptr;
    if (UNEXPECTED(!_method_fn)) {
        _method_fn = php::getMethod(LITERAL_STRING[411], LITERAL_STRING[415]);
    }
...
HTMLDocument HTMLDocument::createFromString(const Variant &source,
    ...
    static THREAD_LOCAL zend_function *_method_fn = nullptr;
    if (UNEXPECTED(!_method_fn)) {
        _method_fn = php::getMethod(LITERAL_STRING[411], LITERAL_STRING[417]);
    }
...
XMLDocument::XMLDocument() {
    this_ = newObject(LITERAL_STRING[426]);
}
XMLDocument XMLDocument::createEmpty(const Variant &version, const Variant &encoding) {
    static THREAD_LOCAL zend_function *_method_fn = nullptr;
    if (UNEXPECTED(!_method_fn)) {
        _method_fn = php::getMethod(LITERAL_STRING[426], LITERAL_STRING[413]);
    }
...
XMLDocument XMLDocument::createFromFile(const Variant &path, const Variant &options, const Variant &override_encoding) {
    static THREAD_LOCAL zend_function *_method_fn = nullptr;
    if (UNEXPECTED(!_method_fn)) {
        _method_fn = php::getMethod(LITERAL_STRING[426], LITERAL_STRING[415]);
    }
...
XMLDocument XMLDocument::createFromString(const Variant &source,
    ...
    static THREAD_LOCAL zend_function *_method_fn = nullptr;
    if (UNEXPECTED(!_method_fn)) {
        _method_fn = php::getMethod(LITERAL_STRING[426], LITERAL_STRING[417]);
    }
...
Implementation::Implementation() {
    this_ = newObject(LITERAL_STRING[343]);
}
...
DOMException::DOMException(const Variant &message, const Variant &code, const Variant &previous) {
    this_ = newObject(LITERAL_STRING[338], {message, code, previous});
}
DOMNode::DOMNode() {
    this_ = newObject(LITERAL_STRING[345]);
}
...
DOMNameSpaceNode::DOMNameSpaceNode() {
    this_ = newObject(LITERAL_STRING[369]);
}
...
Variant DOMDocumentFragment::appendXML(const Variant &data) {
    static THREAD_LOCAL zend_function *_method_fn = nullptr;
    if (UNEXPECTED(!_method_fn)) {
        _method_fn = php::getMethod(this_.ce(), LITERAL_STRING[371]);
    }
    return this_.call(_method_fn, {data});
}
DOMNodeList::DOMNodeList() {
    this_ = newObject(LITERAL_STRING[430]);
}
...
DOMAttr::DOMAttr(const Variant &name, const Variant &value) {
    this_ = newObject(LITERAL_STRING[451], {name, value});
}
...
DOMElement::DOMElement(const Variant &qualified_name, const Variant &value, const Variant &namespace_) {
    this_ = newObject(LITERAL_STRING[455], {qualified_name, value, namespace_});
}
...
DOMText::DOMText(const Variant &data) {
    this_ = newObject(LITERAL_STRING[482], {data});
}
...
DOMComment::DOMComment(const Variant &data) {
    this_ = newObject(LITERAL_STRING[487], {data});
}
DOMDocument::DOMDocument(const Variant &version, const Variant &encoding) {
    this_ = newObject(LITERAL_STRING[379], {version, encoding});
}
...
Variant DOMXPath::quote(const Variant &str) {
    static THREAD_LOCAL zend_function *_method_fn = nullptr;
    if (UNEXPECTED(!_method_fn)) {
        _method_fn = php::getMethod(LITERAL_STRING[501], LITERAL_STRING[508]);
    }
    return php::call(_method_fn, {str});
}
}  // namespace php
