...
Variant DateTime::createFromTimestamp(const Variant &timestamp) {
    static Variant fn { ZEND_STRL("DateTime::createFromTimestamp"), true };
    return fn({timestamp});
}
...
Variant DateTime::getMicrosecond() {
    return this_.exec("getMicrosecond", {});
}
...
Variant DateTime::setMicrosecond(const Variant &microsecond) {
    return this_.exec("setMicrosecond", {microsecond});
}
...
Variant DateTimeImmutable::createFromTimestamp(const Variant &timestamp) {
    static Variant fn { ZEND_STRL("DateTimeImmutable::createFromTimestamp"), true };
    return fn({timestamp});
}
