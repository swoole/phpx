...
Variant Phar::webPhar(const Variant &alias, const Variant &index, const Variant &file_not_found_script, const Variant &mime_types, const Variant &rewrite) {
...
Variant PharData::webPhar(const Variant &alias, const Variant &index, const Variant &file_not_found_script, const Variant &mime_types, const Variant &rewrite) {
