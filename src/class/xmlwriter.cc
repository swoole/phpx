...
Variant XMLWriter::toUri(const Variant &uri) {
    static Variant fn { ZEND_STRL("XMLWriter::toUri"), true };
    return fn({uri});
}
...
Variant XMLWriter::toMemory() {
    static Variant fn { ZEND_STRL("XMLWriter::toMemory"), true };
    return fn({});
}

Variant XMLWriter::toStream(const Variant &stream) {
    static Variant fn { ZEND_STRL("XMLWriter::toStream"), true };
    return fn({stream});
}
