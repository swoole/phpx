...
Variant ReflectionProperty::isPrivateSet() {
    return this_.exec("isPrivateSet", {});
}

Variant ReflectionProperty::isProtectedSet() {
    return this_.exec("isProtectedSet", {});
}
...
Variant ReflectionProperty::getSettableType() {
    return this_.exec("getSettableType", {});
}
...
ReflectionConstant::ReflectionConstant(const Variant &name) {
    this_ = newObject("ReflectionConstant", {name});
}
...
Variant PropertyHookType::cases() {
    static Variant fn { ZEND_STRL("PropertyHookType::cases"), true };
    return fn({});
}

Variant PropertyHookType::from(const Variant &value) {
    static Variant fn { ZEND_STRL("PropertyHookType::from"), true };
    return fn({value});
}

Variant PropertyHookType::tryFrom(const Variant &value) {
    static Variant fn { ZEND_STRL("PropertyHookType::tryFrom"), true };
    return fn({value});
}
