...
Variant Redis::georadius(const Variant &key, const Variant &lng, const Variant &lat, const Variant &radius, const Variant &unit, const Variant &options) {
    return this_.exec("georadius", {key, lng, lat, radius, unit, options});
}

Variant Redis::georadius_ro(const Variant &key, const Variant &lng, const Variant &lat, const Variant &radius, const Variant &unit, const Variant &options) {
    return this_.exec("georadius_ro", {key, lng, lat, radius, unit, options});
}

Variant Redis::georadiusbymember(const Variant &key, const Variant &member, const Variant &radius, const Variant &unit, const Variant &options) {
    return this_.exec("georadiusbymember", {key, member, radius, unit, options});
}

Variant Redis::georadiusbymember_ro(const Variant &key, const Variant &member, const Variant &radius, const Variant &unit, const Variant &options) {
    return this_.exec("georadiusbymember_ro", {key, member, radius, unit, options});
}

Variant Redis::geosearch(const Variant &key, const Variant &position, const Variant &shape, const Variant &unit, const Variant &options) {
    return this_.exec("geosearch", {key, position, shape, unit, options});
}

Variant Redis::geosearchstore(const Variant &dst, const Variant &src, const Variant &position, const Variant &shape, const Variant &unit, const Variant &options) {
...
Variant RedisCluster::georadius(const Variant &key, const Variant &lng, const Variant &lat, const Variant &radius, const Variant &unit, const Variant &options) {
    return this_.exec("georadius", {key, lng, lat, radius, unit, options});
}

Variant RedisCluster::georadius_ro(const Variant &key, const Variant &lng, const Variant &lat, const Variant &radius, const Variant &unit, const Variant &options) {
    return this_.exec("georadius_ro", {key, lng, lat, radius, unit, options});
}

Variant RedisCluster::georadiusbymember(const Variant &key, const Variant &member, const Variant &radius, const Variant &unit, const Variant &options) {
    return this_.exec("georadiusbymember", {key, member, radius, unit, options});
}

Variant RedisCluster::georadiusbymember_ro(const Variant &key, const Variant &member, const Variant &radius, const Variant &unit, const Variant &options) {
    return this_.exec("georadiusbymember_ro", {key, member, radius, unit, options});
}

Variant RedisCluster::geosearch(const Variant &key, const Variant &position, const Variant &shape, const Variant &unit, const Variant &options) {
    return this_.exec("geosearch", {key, position, shape, unit, options});
}

Variant RedisCluster::geosearchstore(const Variant &dst, const Variant &src, const Variant &position, const Variant &shape, const Variant &unit, const Variant &options) {
    return this_.exec("geosearchstore", {dst, src, position, shape, unit, options});
}
...
Variant RedisCluster::hscan(const Variant &key, const Reference &iterator, const Variant &pattern, const Variant &count) {
    return this_.exec("hscan", {key, &iterator, pattern, count});
}
...
Variant RedisCluster::scan(const Reference &iterator, const Variant &key_or_address, const Variant &pattern, const Variant &count) {
...
Variant RedisCluster::sscan(const Variant &key, const Reference &iterator, const Variant &pattern, const Variant &count) {
    return this_.exec("sscan", {key, &iterator, pattern, count});
}
...
Variant RedisCluster::zrangebyscore(const Variant &key, const Variant &start, const Variant &end, const Variant &options) {
    return this_.exec("zrangebyscore", {key, start, end, options});
}
...
Variant RedisCluster::zscan(const Variant &key, const Reference &iterator, const Variant &pattern, const Variant &count) {
    return this_.exec("zscan", {key, &iterator, pattern, count});
}
