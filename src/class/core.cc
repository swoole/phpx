...
RequestParseBodyException::RequestParseBodyException(const Variant &message, const Variant &code, const Variant &previous) {
    this_ = newObject("RequestParseBodyException", {message, code, previous});
}
...
Deprecated::Deprecated(const Variant &message, const Variant &since) {
    this_ = newObject("Deprecated", {message, since});
}
