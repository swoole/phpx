...
Variant ErrorException::getSeverity() {
    return this_.call(LITERAL_STRING[106], {});
}
...
Variant Generator::send(const Variant &value) {
    return this_.call(LITERAL_STRING[123], {value});
}
Variant Generator::_throw(const Variant &exception) {
    return this_.call(LITERAL_STRING[124], {exception});
}
Variant Generator::getReturn() {
    return this_.call(LITERAL_STRING[125], {});
}
...
Variant WeakReference::get() {
    return this_.call(LITERAL_STRING[131], {});
}
...
Variant WeakMap::offsetSet(const Variant &object, const Variant &value) {
    return this_.call(LITERAL_STRING[133], {object, value});
}
...
Variant Fiber::resume(const Variant &value) {
    return this_.call(LITERAL_STRING[149], {value});
}
Variant Fiber::_throw(const Variant &exception) {
    return this_.call(LITERAL_STRING[124], {exception});
}
Variant Fiber::isStarted() {
    return this_.call(LITERAL_STRING[150], {});
}
Variant Fiber::isSuspended() {
    return this_.call(LITERAL_STRING[151], {});
}
Variant Fiber::isRunning() {
    return this_.call(LITERAL_STRING[152], {});
}
Variant Fiber::isTerminated() {
    return this_.call(LITERAL_STRING[153], {});
}
