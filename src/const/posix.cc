...
Variant POSIX_SC_ARG_MAX{0};
Variant POSIX_SC_CHILD_MAX{1};
Variant POSIX_SC_CLK_TCK{2};
Variant POSIX_SC_PAGESIZE{30};
Variant POSIX_SC_NPROCESSORS_CONF{83};
Variant POSIX_SC_NPROCESSORS_ONLN{84};
Variant POSIX_PC_LINK_MAX{0};
Variant POSIX_PC_MAX_CANON{1};
Variant POSIX_PC_MAX_INPUT{2};
Variant POSIX_PC_NAME_MAX{3};
Variant POSIX_PC_PATH_MAX{4};
Variant POSIX_PC_PIPE_BUF{5};
Variant POSIX_PC_CHOWN_RESTRICTED{6};
Variant POSIX_PC_NO_TRUNC{7};
Variant POSIX_PC_ALLOC_SIZE_MIN{18};
Variant POSIX_PC_SYMLINK_MAX{19};
}  // namespace php
