...
// copy from https://github.com/php/php-src/blob/master/build/gen_stub.php
...
require_once dirname(__DIR__).'/console/vendor/autoload.php';
...
function initPhpParser() {
    ...
    if (class_exists(PhpParser\Lexer::class)) {
        return;
    }
