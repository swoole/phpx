...
Variant finfo_open(const Variant &flags = 0, const Variant &magic_database = nullptr);
...
Variant finfo_file(const finfo &finfo,
...
Variant finfo_file(const Variant &finfo,
                   ...
                   const Variant &flags = 0,
                   const Variant &context = nullptr);
Variant finfo_buffer(const finfo &finfo,
