...
Variant gzwrite(const Variant &stream, const Variant &data, const Variant &length = nullptr);
Variant gzputs(const Variant &stream, const Variant &data, const Variant &length = nullptr);
...
Variant gzgets(const Variant &stream, const Variant &length = nullptr);
