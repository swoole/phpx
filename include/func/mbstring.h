...
Variant mb_strpos(const Variant &haystack, const Variant &needle, const Variant &offset = 0, const Variant &encoding = {});
Variant mb_strrpos(const Variant &haystack, const Variant &needle, const Variant &offset = 0, const Variant &encoding = {});
Variant mb_stripos(const Variant &haystack, const Variant &needle, const Variant &offset = 0, const Variant &encoding = {});
Variant mb_strripos(const Variant &haystack, const Variant &needle, const Variant &offset = 0, const Variant &encoding = {});
Variant mb_strstr(const Variant &haystack, const Variant &needle, const Variant &before_needle = false, const Variant &encoding = {});
Variant mb_strrchr(const Variant &haystack, const Variant &needle, const Variant &before_needle = false, const Variant &encoding = {});
Variant mb_stristr(const Variant &haystack, const Variant &needle, const Variant &before_needle = false, const Variant &encoding = {});
Variant mb_strrichr(const Variant &haystack, const Variant &needle, const Variant &before_needle = false, const Variant &encoding = {});
...
Variant mb_encode_mimeheader(const Variant &string, const Variant &charset = {}, const Variant &transfer_encoding = {}, const Variant &newline = "\r\n", const Variant &indent = 0);
...
Variant mb_convert_variables(const Variant &to_encoding, const Variant &from_encoding, const Reference &var, const Args&... vars) {
    return call("mb_convert_variables", {to_encoding, from_encoding, &var, vars...});
}
Variant mb_encode_numericentity(const Variant &string, const Variant &map, const Variant &encoding = {}, const Variant &hex = false);
Variant mb_decode_numericentity(const Variant &string, const Variant &map, const Variant &encoding = {});
Variant mb_send_mail(const Variant &to, const Variant &subject, const Variant &message, const Variant &additional_headers = Array{}, const Variant &additional_params = {});
...
Variant mb_str_pad(const Variant &string, const Variant &length, const Variant &pad_string = " ", const Variant &pad_type = 1, const Variant &encoding = {});
