...
Variant hash_file(const Variant &algo, const Variant &filename, const Variant &binary = false, const Variant &options = Array{});
...
Variant hash_init(const Variant &algo, const Variant &flags = 0, const Variant &key = "", const Variant &options = Array{});
...
Variant hash_pbkdf2(const Variant &algo, const Variant &password, const Variant &salt, const Variant &iterations, const Variant &length = 0, const Variant &binary = false, const Variant &options = Array{});
Variant hash_equals(const Variant &known_string, const Variant &user_string);
Variant hash_hkdf(const Variant &algo, const Variant &key, const Variant &length = 0, const Variant &info = "", const Variant &salt = "");
}
