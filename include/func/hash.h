...
Variant hash_update_file(const HashContext &context, const Variant &filename, const Variant &stream_context = nullptr);
Variant hash_update_file(const Variant &context, const Variant &filename, const Variant &stream_context = nullptr);
