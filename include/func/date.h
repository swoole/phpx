...
Variant date_time_set(const Variant &object, const Variant &hour, const Variant &minute, const Variant &second = 0, const Variant &microsecond = 0);
Variant date_date_set(const Variant &object, const Variant &year, const Variant &month, const Variant &day);
Variant date_isodate_set(const Variant &object, const Variant &year, const Variant &week, const Variant &day_of_week = 1);
...
Variant timezone_transitions_get(const Variant &object, const Variant &timestamp_begin = LONG_MIN, const Variant &timestamp_end = LONG_MAX);
...
Variant date_sunrise(const Variant &timestamp, const Variant &return_format = 1, const Variant &latitude = {}, const Variant &longitude = {}, const Variant &zenith = {}, const Variant &utc_offset = {});
Variant date_sunset(const Variant &timestamp, const Variant &return_format = 1, const Variant &latitude = {}, const Variant &longitude = {}, const Variant &zenith = {}, const Variant &utc_offset = {});
