...
Variant curl_file_create(const Variant &filename,
                         const Variant &mime_type = nullptr,
                         const Variant &posted_filename = nullptr);
Variant curl_getinfo(const CurlHandle &handle, const Variant &option = nullptr);
Variant curl_getinfo(const Variant &handle, const Variant &option = nullptr);
CurlHandle curl_init(const Variant &url = nullptr);
...
Variant curl_multi_info_read(const CurlMultiHandle &multi_handle, const Reference &queued_messages = nullptr);
Variant curl_multi_info_read(const Variant &multi_handle, const Reference &queued_messages = nullptr);
