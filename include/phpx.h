...
class String {
  public:
    ...
    bool equals(const String &str, bool ci = false) const {
        if (str.length() != value->len) {
            return false;
        }
        if (ci) {
...
static String ini_get(String varname) {
...
static Variant get_cfg_name(String varname) {
