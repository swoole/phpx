...
class SQLite3 {
  ...
  public:
    ...
    static constexpr zend_long OK = 0;
    static constexpr zend_long DENY = 1;
    static constexpr zend_long IGNORE = 2;
    static constexpr zend_long CREATE_INDEX = 1;
    static constexpr zend_long CREATE_TABLE = 2;
    static constexpr zend_long CREATE_TEMP_INDEX = 3;
    static constexpr zend_long CREATE_TEMP_TABLE = 4;
    static constexpr zend_long CREATE_TEMP_TRIGGER = 5;
    static constexpr zend_long CREATE_TEMP_VIEW = 6;
    static constexpr zend_long CREATE_TRIGGER = 7;
    static constexpr zend_long CREATE_VIEW = 8;
    static constexpr zend_long DELETE = 9;
    static constexpr zend_long DROP_INDEX = 10;
    static constexpr zend_long DROP_TABLE = 11;
    static constexpr zend_long DROP_TEMP_INDEX = 12;
    static constexpr zend_long DROP_TEMP_TABLE = 13;
    static constexpr zend_long DROP_TEMP_TRIGGER = 14;
    static constexpr zend_long DROP_TEMP_VIEW = 15;
    static constexpr zend_long DROP_TRIGGER = 16;
    static constexpr zend_long DROP_VIEW = 17;
    static constexpr zend_long INSERT = 18;
    static constexpr zend_long PRAGMA = 19;
    static constexpr zend_long READ = 20;
    static constexpr zend_long SELECT = 21;
    static constexpr zend_long TRANSACTION = 22;
    static constexpr zend_long UPDATE = 23;
    static constexpr zend_long ATTACH = 24;
    static constexpr zend_long DETACH = 25;
    static constexpr zend_long ALTER_TABLE = 26;
    static constexpr zend_long REINDEX = 27;
    static constexpr zend_long ANALYZE = 28;
    static constexpr zend_long CREATE_VTABLE = 29;
    static constexpr zend_long DROP_VTABLE = 30;
    static constexpr zend_long FUNCTION = 31;
    static constexpr zend_long SAVEPOINT = 32;
    static constexpr zend_long COPY = 0;
    static constexpr zend_long RECURSIVE = 33;
